...
export const routes: Routes = [
  ...
  { path: 'perfil', component: UserProfileComponent, canMatch: [userGuard] },
  { path: 'notas', component: UserNotesComponent, canMatch: [userGuard] },
  { path: 'notas/:id', component: UserModNotesComponent, canMatch: [userGuard] },
  { path: 'crearNota', component: UserNewNotesComponent, canMatch: [userGuard] },
  { path: 'proyectos', component: UserProyectsComponent, canMatch: [userGuard] },
  { path: 'proyectos/:id', component: UserModProyectsComponent, canMatch: [userGuard] },
  { path: 'crearProyecto', component: UserNewProyectsComponent, canMatch: [userGuard] },
  ...
  { path: 'userHome', component: UserDashComponent, canMatch: [userGuard]},
